...
(18, 8, 'Nhiều tour mùa hè giảm giá hàng chục triệu đồng', '<p>C&aacute;c tour trong v&agrave; ngo&agrave;i nước đều được giảm gi&aacute; mạnh để k&iacute;ch cầu du lịch trong dịp h&egrave;, nhiều chương tr&igrave;nh khuyến m&atilde;i l&ecirc;n đến h&agrave;ng chục triệu đồng.</p>\r\n\r\n<p>Sau khi so s&aacute;nh tiền v&eacute; m&aacute;y bay, ph&ograve;ng kh&aacute;ch sạn ở Bali để chuẩn bị cho kỳ nghỉ h&egrave; của gia đ&igrave;nh, anh Sơn (ngụ quận 2, TP HCM) quyết định chuyển sang mua tour trọn g&oacute;i v&igrave; tiết kiệm hơn.</p>', 'active', 'd2ABCeBzoR.jpeg', '2019-05-15 00:00:00', 'hailan', '2023-04-02 09:04:07', 'admin', '2019-05-15', 'normal'),
...
INSERT INTO `category` (`id`, `name`, `status`, `ordering`, `created`, `created_by`, `modified`, `modified_by`, `is_home`, `display`) VALUES
(1, 'Thể thao', 'active', 5, '2019-05-04 00:00:00', 'admin', '2019-05-12 00:00:00', 'hailan', 'yes', 'grid'),
(2, 'Giáo dục', 'active', 0, '2019-05-04 00:00:00', 'admin', '2019-05-12 00:00:00', 'hailan', 'no', 'list'),
(3, 'Sức khỏe', 'active', 15, '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:33', 'hailan', 'no', 'list'),
(4, 'Du lịch', 'active', 0, '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:30', 'hailan', 'no', 'list'),
(5, 'Khoa học', 'active', 0, '2019-05-04 00:00:00', 'admin', '2019-05-12 00:00:00', 'hailan', 'no', 'list'),
(6, 'Số hóa', 'active', 0, '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:38', 'hailan', 'no', 'list'),
(7, 'Xe - Ô tô', 'active', 50, '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:36', 'hailan', 'no', 'list'),
(8, 'Kinh doanh', 'inactive', 10, '2019-05-12 00:00:00', 'hailan', NULL, NULL, 'no', 'grid'),
(10, 'CNTT', 'active', 1, '2023-04-01 09:04:48', 'admin', NULL, NULL, 'yes', 'list');
...
CREATE TABLE `menu` (
  ...
  `type_menu` varchar(45) NOT NULL,
  `type_open` varchar(45) NOT NULL,
  `created` datetime DEFAULT NULL,
  `created_by` varchar(45) DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  `modified_by` varchar(45) DEFAULT NULL
...
INSERT INTO `menu` (`id`, `name`, `status`, `ordering`, `link`, `type_menu`, `type_open`, `created`, `created_by`, `modified`, `modified_by`) VALUES
(2, 'sản phẩm ', 'active', 4, '/', 'category_article', 'current', NULL, '', NULL, ''),
(3, 'Blog', 'active', 3, '/blog', 'category_product', 'current', NULL, '', NULL, ''),
(4, 'Quản lý Slider123', 'active', 1, '/suoce', 'link', 'current', '2023-04-10 10:04:22', 'admin', '2023-04-10 10:04:37', 'admin');
...
(1, 'Thế giới', 'active', 'https://vnexpress.net/rss/the-gioi.rss', 0, 'VnExpress', '2023-04-07 15:53:54', 'admin', '2023-04-08 08:04:30', 'admin'),
(2, 'Thời sự', 'active', 'https://vnexpress.net/rss/thoi-su.rss', 20, '24h', '2023-04-07 06:04:57', 'admin', NULL, NULL),
(3, 'Sức khoẻ', 'inactive', 'https://vnexpress.net/rss/suc-khoe.rss', 20, 'ThannNien', '2023-04-07 08:04:39', 'admin', NULL, NULL),
(5, 'Kinh doanh', 'active', 'https://vnexpress.net/rss/kinh-doanh.rss', 2, 'VnExpress', '2023-04-10 10:04:36', 'admin', NULL, NULL);
...
(1, 'Khóa học lập trình Frontend Master', 'Khóa học sẽ giúp bạn trở thành một chuyên gia Frontend với đầy đủ các kiến thức về HTML, CSS, JavaScript, Bootstrap, jQuery, chuyển PSD thành HTML ...', 'https://zendvn.com/khoa-hoc-lap-trinh-frontend-master/', 'rEpDUQCxe4.jpg', '2019-04-15 00:00:00', 'hailan', '2019-04-24 13:28:03', 'hailan', 'inactive'),
(2, 'Học lập trình trực tuyến', 'Học trực tuyến giúp bạn tiết kiệm chi phí, thời gian, cập nhật được nhiều kiến thức mới nhanh nhất và hiệu quả nhất', 'https://zendvn.com/', 'K6B1O6UNCb.jpg', '2019-04-18 00:00:00', 'hailan', '2019-04-24 13:28:06', 'hailan', 'active'),
(3, 'Ưu đãi học phí', 'Tổng hợp các trương trình ưu đãi học phí hàng tuần, hàng tháng đến tất các các bạn với các mức giảm đặc biệt 50%, 70%,..', 'https://zendvn.com/uu-dai-hoc-phi-tai-zendvn/', 'LWi6hINpXz.jpg', '2019-04-24 00:00:00', 'hailan', '2019-04-24 13:28:09', NULL, 'inactive');
...
(1, 'admin', 'admin@gmail.com', 'admin123456', 'fcea920f7412b5da7be0cf42b8c93759', 'VxkF1WxIj1.jpg', 'admin', '2014-12-10 08:55:35', 'member', '2023-04-09 03:04:13', 'admin', 'active'),
(2, 'hailan', 'hailan@gmail.com', 'hailan', '7c6f3ef49405d8a330aaa19ca0d0f6af', 'JDSWz1nee7.jpg', 'admin', '2014-12-13 07:20:03', 'admin', '2023-04-09 03:04:35', 'admin', 'active'),
(8, 'admin@gmail.com123123', 'dunghoa8792@gmail.com.vn', 'user987', 'e10adc3949ba59abbe56e057f20f883e', '4Dfzy00t4Z.jpg', 'member', '2023-04-09 03:04:23', 'admin', NULL, NULL, 'active');
