...
<div class="technology">
    ...
    <div class="technology_content">
        <div class="post_item post_h_large">
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{{asset('blog/images/article/e7YyFZJCc8.jpeg')}}"
        ...
        <div class="post_item post_h_large">
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{{asset('blog/images/article/exzJEG4WDU.jpeg')}}"
        ...
        <div class="post_item post_h_large">
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{{asset('blog/images/article/TpcocqUjob.png')}}"
        ...
        <div class="post_item post_h_large">
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{{asset('blog/images/article/L3Yuzln8II.png')}}"
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="post_item post_v_small d-flex flex-column align-items-start justify-content-start">
                        <div class="post_image"><img src="{{asset('blog/images/article/gCPGos7mhY.png')}}"
                ...
                <div class="col-lg-6">
                    <div class="post_item post_v_small d-flex flex-column align-items-start justify-content-start">
                        <div class="post_image"><img src="{{asset('blog/images/article/hoyOyXJrzx.png')}}"
    ...
    <div class="row world_row">
        <div class="col-lg-11">
            <div class="row">
                <div class="col-lg-6">
                    <div class="post_item post_v_small d-flex flex-column align-items-start justify-content-start">
                        <div class="post_image"><img src="{{asset('blog/images/article/nt1QxhKUXM.jpeg')}}"
                ...
                <div class="col-lg-6">
                    <div class="post_item post_v_small d-flex flex-column align-items-start justify-content-start">
                        <div class="post_image"><img src="{{asset('blog/images/article/aiC6j6fWZY.png')}}"
                ...
                <div class="col-lg-6">
                    <div class="post_item post_v_small d-flex flex-column align-items-start justify-content-start">
                        <div class="post_image"><img src="{{asset('blog/images/article/9jOZGc7BJK.png')}}"
...
<div class="technology">
    ...
    <div class="technology_content">
        <div class="post_item post_h_large">
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{{asset('blog/images/article/g2c7mYXBPW.png')}}"
        ...
        <div class="post_item post_h_large">
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{{asset('blog/images/article/9fbeUKTBpU.png')}}"
